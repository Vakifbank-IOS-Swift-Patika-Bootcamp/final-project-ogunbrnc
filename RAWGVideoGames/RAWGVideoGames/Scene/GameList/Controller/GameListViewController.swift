...
final class GameListViewController: BaseViewController {
    ...
    @IBOutlet private var gameListTableView: UITableView! {
        didSet {
    ...
    private func configurePickerview() {
        ...
        sortingPickerView.frame = CGRect(x: 0.0, y: UIScreen.main.bounds.size.height - 300, width: UIScreen.main.bounds.size.width, height: 300)
        view.addSubview(sortingPickerView)
    }
